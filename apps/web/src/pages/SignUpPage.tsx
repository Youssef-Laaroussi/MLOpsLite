...
export const SignUpPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#FAFCFB]">
      {/* ── Left Panel: Natural Living Visual Décor (Pure Art & Motion) ── */}
      <div
        className="hidden lg:flex lg:w-[52%] relative overflow-hidden items-center justify-center select-none"
        style={{
          background: "linear-gradient(225deg, #07131D 0%, #0A1B28 35%, #081722 70%, #050E15 100%)",
        }}
      >
        {/* ── Ambient Organic Nebula Glows ── */}
        <div
          className="absolute top-[15%] left-[20%] w-[440px] h-[440px] rounded-full opacity-45 pointer-events-none blur-[120px]"
          style={{
        ...
        />
        <div
          className="absolute bottom-[18%] right-[15%] w-[480px] h-[480px] rounded-full opacity-35 pointer-events-none blur-[140px]"
          style={{
